    ...
    fetch("./datos/productos.json")
        ...
        .then((prods) => {
            prods.forEach(producto => {
                ...
                let disponible = "Añadir al carrito";
                let disponibleClass = "btnAgregarCarrito";
                if (producto.disponible != "si"){
                    disponible = "Agotado";
                    disponibleClass = "noDisponible";
                }
                tarjetaProducto.innerHTML = `
           <div class="tarjetaProducto">
                <div class="caratulaProducto"><img class="imgProducto" src="./assets/productos/bolsas_cafe/${producto.img}" alt="${producto.nombre}">
                </div>
            ...
            <a href="#" class=${disponibleClass }>${disponible}</a>
